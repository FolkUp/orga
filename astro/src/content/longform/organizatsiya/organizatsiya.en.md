---
title: "«Organizatsiya» — a legal performative, ratified by the state"
...
# Subject
subject_artist: "Oxxxymiron (Miron Fyodorov)"
...
# Verification status (banking-level) — D33: all false at skeleton, flip per-step only
fact_verified: true
...
editorial_reviewed_by:
  - "Цветик (prosody, 11 lyric fragments locked)"
  - "Наборщик (EN personal-essay register)"
  - "Фонарщик (Act-1 mini-review + full brand-voice read)"
hostile_verified: true
hostile_verified_by:
  - "Alpha (opus, structural — PASS)"
  - "Beta (sonnet, reader-experience — CONDITIONAL_PASS, Mandelstam Para 2 compression applied; 2 advisory warnings overruled with documented reasoning)"
hostile_verified_date: 2026-04-20
...
# Sources
sources:
  - title: "Complete lyrics of «Организация» (LyricFind)"
    file: _meta/sources/organizatsiya-lyrics-full.md
    type: primary
  - title: "Fontanka: Oxxxymiron releases the single «Организация»"
  ...
  - title: "Russia Labels Star Rapper Oxxxymiron a 'Foreign Agent'"
    ...
    type: news
    date: 2022-10-07
  - title: "Russian Federation register of persons performing the functions of a foreign agent"
    url: "https://minjust.gov.ru/ru/activity/directions/942/spisok-lic-vypolnyayushih-funkcii-inostrannogo-agenta/"
    type: government
  - title: "Oxxxymiron «Организация» — official video"
  ...
  - title: "Spotify — «Организация»"
    ...
    type: media
  - title: "Federal Law No. 114-FZ «On Countering Extremist Activities» (25 July 2002)"
    url: "https://www.consultant.ru/document/cons_doc_LAW_37867/"
    type: legislation
  - title: "Federal Law No. 121-FZ (20 July 2012) — non-commercial organizations performing the functions of a foreign agent"
    url: "https://www.consultant.ru/document/cons_doc_LAW_132900/"
    type: legislation
  - title: "Federal Law No. 129-FZ (23 May 2015) — undesirable organizations"
    url: "https://base.garant.ru/71035684/"
    type: legislation

# Audio embed — unchanged from RU (language-neutral)
audio_embed:
  primary: spotify
...
*Translations of "Organizatsiya" are by the author. Transliterated Russian terms are glossed on first use.*
...
> No leader, no rite, no flag
> But we will remain, and those who war with us
> Will be gone, like Stasi and Gestapo

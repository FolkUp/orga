...
description: "Как Андеграунд применяет автоматизированные инструменты в редакционном процессе, в соответствии с EU AI Act Article 50."
...
Андеграунд исследует андерграундную культуру. Эта страница объясняет, как автоматизированные инструменты применяются в нашем редакционном процессе, в соответствии с принципом прозрачности **EU AI Act, Article 50**.

## Где применяются автоматизированные инструменты

### Верификация и ресёрч

Каждая дата, цифра и атрибуция в наших лонгридах сверяется с независимыми публичными источниками. Автоматизированные поиски и инструменты source-matching помогают в этой верификации — они подтягивают кандидатов в источники и сигнализируют о несоответствиях, но не заменяют человеческое суждение. Решает, чему можно доверять, редактор.
...
- **Авторство.** Наши лонгриды написаны людьми. Автоматизированные инструменты не генерируют финальный текст.
...
Финальная ответственность за каждую опубликованную статью — за текст, факты, мнения и compliance — лежит на редакционной команде Андеграунд, которая входит в FolkUp. Автоматизированные инструменты — средство повышения продуктивности и контроля качества; они не размывают редакционную подотчётность.

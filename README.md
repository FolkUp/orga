# ORGA — Платформа культурных исследований
...
Мультимедийная платформа для культурных исследований: фреймворк для OSINT-расследований культурных феноменов с банковским уровнем верификации.

## 🎯 Проект

Исследовательская платформа для культурного анализа с возможностями мультимедийного storytelling и банковским уровнем верификации фактов. Повторяемый фреймворк для будущих расследований.
...
orga/
├── content/
│   └── investigations/     # Фреймворк для расследований
├── data/
│   └── timeline/          # Компоненты временных шкал
├── static/
